...
function nav_burger() {
	...
	if (html_tag.classList.contains('m2a')) {
		...
		new_css('css-menu', '//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async-menu.css?v=36590982183417486461690189282');
	}
}
...
function asyncCSS() {
	"use strict";
	new_css('async-css', '//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async.css?v=52509283729687325021690189280');
}
...
function asyncCSS() {
	"use strict";
	new_css('async-css', '//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async.css?v=52509283729687325021690189280');
	new_css('hovers-css', '//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async-hovers.css?v=183925157669328894071690189280');
}
if (!isMobile) {
...
function validate_me(el) {
	"use strict";
  loadRes("//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/plugin-validator.js?v=6870176241344699201690189301", function () {
		...
		new_css('form-validation-css', "//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async-validation.css?v=135226482748542705341690189280");
	}, 'validator-loaded');
...
if (form_product_sticky.length) {
	Array.from(form_product_sticky).forEach(function (el) {
		...
		/*if(el.classList.contains('visible')){
			new_css('css-product-scrolled', '//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async-product-scrolled.css?v=19869886983330127861690189282');
...
window.addEventListener("semanticSelect", function (evt) {
	...
	if (select_tag.length && !isMobile) {
		loadRes("//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/plugin-selects.js?v=182514790985858337051690189282", function () {
			"use strict";
			Array.from(select_tag).forEach(function (el) {
				...
				if (!isMobile) {
					...
					Array.from(el.nextSibling.querySelectorAll('.bv_ul_inner a')).forEach(function (em) {
						em.addEventListener('click', function () {
							...
							if (em.hasAttribute('data-l4pr-index')) {
								document.getElementsByClassName('l4pr')[0].children[0].swiper.slideTo(em.getAttribute('data-l4pr-index'));
					...
					Array.from(el.parentNode.getElementsByClassName('bv_atual')).forEach(function (em) {
						em.addEventListener('click', function () {
							new_css('css-select', '//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async-select.css?v=116768044393015328621690189281');
						});
...
// new_css('css-panels', '//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async-panels.css?v=48796026522504069801690189282');
if (module_panel.length) {
	function openPanel(id) {
		...
		if (document.getElementsByClassName('f8fl').length) {
			new_css('css-filters', '//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async-filters.css?v=39139715983742956191690189282');
		}
		getStickyFooters();
		new_css('css-panels', '//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async-panels.css?v=48796026522504069801690189282');
	}
...
window.addEventListener("imageCompare", function(evt) {
	...
	if (image_compare.length) {
		loadRes('//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/plugin-compare.js?v=108280108769912210341690189281', function () {
			"use strict";
			new_css('compare-css', '//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async-compare.css?v=61498998280410013761690189279');
...
window.addEventListener("inputDate", function(evt) {
	...
	if (input_date.length && !isMobile) {
		...
		new_css('datepicker-css', '//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async-datepicker.css?v=165252557381951514801690189282');
		if (datepicker_langs.includes(global_lang)) {
			...
			loadRes('//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/plugin-datepicker.js?v=68956638202748940181690189282', function () {
	...
	if (search_id) {
		...
		Array.from(search_input).forEach(function (el) {
			...
			el.addEventListener('focus', function () {
				...
				new_css('css-search', '//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async-search.css?v=73015925010885649431690189282');
			});
		});
...
window.addEventListener("schemeTooltip", function (evt) {
	...
	if (scheme_tooltip.length) {
		// new_css('css-tooltips', "//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async-tooltips.css?604");
...
var loadPopup = function (id) {
	"use strict";
	loadRes('//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/plugin-popups.js?v=124494305298082104201690189301', function () {
...
window.addEventListener("rangeSlider", function(evt) {
	...
	if (input_range.length) {
		...
		loadRes("//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/plugin-sliders.js?v=106367203436165194411690189280", function () {
			"use strict";
			new_css('form-sliders-css', '//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async-ui-sliders.css?v=72896717569740218131690189280');
...
/*window.addEventListener("masonry", function(evt) {
	...
	if (list_featured.length) {
		loadRes("//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/plugin-masonry.js?v=19905838331864423561690189281", function () {
			"use strict";
...
window.addEventListener("stickyNav", function(evt) {
	...
	if (top_bar) {
		...
		if (Cookies.get('notice', { sameSite: 'none', secure: true }) === 'closed') {
			...
			new_css('announcement-css', '//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async-announcement.css?v=179453402485244085771690189280');
...
window.addEventListener("countdown", function(evt) {
	...
	if (countdown_tag.length) {
		loadRes('//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/plugin-countdown.js?v=30852516867416231701690189282', function () {
			"use strict";
...
if (list_count.length) {
	loadRes('//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/plugin-countup.js?v=23403240054145588091690189281', function () {
		"use strict";
...
if (link_print.length) {
	Array.from(link_print).forEach(function (el) {
		"use strict";
		el.addEventListener('click', function (e) {
			new_css('css-print', '//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async-print.css?v=98634256293469202081690189280');
			setTimeout(function () {
				window.print();
			}, 400);
			e.preventDefault();
	...
	if (data_fancybox.length) {
		Array.from(data_fancybox).forEach(function (el, index) {
			...
			el.addEventListener('click', function (e) {
				...
				loadRes("//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/plugin-fancybox.js?v=53225757861153421831690189281", function () {
					new_css('css-fancybox', '//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async-fancybox.css?v=123126178332476150511690189281');
...
window.addEventListener("hotspots", function (evt) {
	...
	if (list_hotspots.length) {
		new_css('css-hotspots', '//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async-hotspots.css?v=149621784538869558091690189279');
...
window.addEventListener("maqruee", function (evt) {
	...
	if (module_maqruee.length) {
		loadRes("//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/plugin-typewritter.js?v=141057276794469966851690189282", function () {
		...
		new_css('css-marquee', '//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async-marquee.css?v=119070173001214993091690189281');
	}
});
