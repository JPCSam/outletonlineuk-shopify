...
function create_slider(el, settings, minSlides) {
	...
	if (el.children.length > 1) {
		//new_css('css-swiper', '//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/async-swiper.css?v=111603181540343972631690189281');
		...
		Default = {
			utils: {
								...
								if (el.tagName.toLowerCase() === 'a') {
									el.addEventListener('click', function (e) {
										if (html_tag.classList.contains('t1ac')) {
											...
											new_css('accessible-mode-css', "//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/theme-accessible.css?v=183390142599239287431690189281");
				...
				mobile: function () {
					...
					new_js("//cdn.shopify.com/s/files/1/0758/8465/9005/t/4/assets/scripts-async.js?v=52710470506468695941695045553");
				},
				ratings: function () {
